...
export const useCreatorFilesState = (creatorId?: string) => {
  ...
  return {
    creator,
    isCurrentUserCreator: isCurrentUserCreator || permissions.canEdit || permissions.canDelete,
    error,
    isLoading,
    filteredFiles,
    currentFolder,
