  ...
  return <div className="px-2">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button 
            variant="ghost" 
            className="w-full justify-start p-2 rounded-xl transition-all duration-300 hover:bg-gradient-premium-yellow"
          >
            <div className="flex items-center gap-3 w-full min-w-0">
              ...
              <div className="flex-1 flex flex-col text-left min-w-0">
                ...
                <span className="text-xs text-muted-foreground hover:text-black">User</span>
              </div>
              <ChevronDown className="h-4 w-4 text-muted-foreground hover:text-black flex-shrink-0" />
            </div>
          </Button>
        </DropdownMenuTrigger>
