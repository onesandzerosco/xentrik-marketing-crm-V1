...
interface MonthlyQuestCompletionModalProps {
  ...
  slot: MonthlyQuestSlot;
  onSubmitComplete: () => void;
}

const MonthlyQuestCompletionModal: React.FC<MonthlyQuestCompletionModalProps> = ({
  open,
  onOpenChange,
  slot,
  onSubmitComplete,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Check if an assignment exists for this quest this month
      ...
      if (completionError) {
        if (completionError.code === '23505') {
          throw new Error('You have already submitted this quest this month');
        }
...
export default MonthlyQuestCompletionModal;
